...
export const chinesetw: IAppStrings = {
    ...
    homePage: {
        ...
        importProject: {
            ...
            confirmation:
                "您確定要將專案${project.file.name}的設定轉換為v2格式嗎？我們建議您首先備份專案文件。"
    ...
    connections: {
        ...
        imageCorsWarning:
            "警告：在Web瀏覽器中使用VoTT時，由於CORS（跨源資源共享）限制，來自Bing Image Search的某些圖像數據可能無法正確匯出。",
        ...
        blobCorsWarning:
            "警告：必須在Azure Blob儲存體帳戶上啟用CORS（跨域資源共享），才能將其用作來源或目標連接。 {0}中提供了有關啟用CORS的更多資訊。",
    ...
    editorPage: {
        ...
        messages: {
            enforceTaggedRegions: {
                ...
                description:
                    "一個或多個區域尚未被標記。在繼續下一個圖像數據之前，請確保所有區域均已標記。"
    ...
    errors: {
        ...
        projectInvalidSecurityToken: {
            ...
            message:
                "專案使用的安全性認證無效。請驗證是否在您的應用程式設定中正確的設定了專案的安全性認證"
        ...
        projectInvalidJson: {
            ...
            message:
                "所選擇的專案文件不包含有效的JSON格式。請確認該專案檔案並且重試。"
        ...
        projectDeleteError: {
            ...
            message:
                "刪除專案時發生錯誤。請確認專案檔案和安全性認證是否存在，然後重試"
        ...
        securityTokenNotFound: {
            ...
            message:
                "在當前的應用程式設定中找不到該專案所使用的安全性認證。請確認安全性認證是否存在，然後嘗試重新載入專案。"
        ...
        activeLearningPredictionError: {
            ...
            message:
                "在預測當前圖像數據中的區域時發生錯誤。請確認您的主動學習相關設定，然後重試"
