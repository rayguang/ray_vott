...
export const spanish: IAppStrings = {
    ...
    connections: {
        ...
        providers: {
            ...
            minio: {
                ...
                createFolder: {
                    title: "Crear  directorio",
                    description: "Crear Minio directorio si no excite"
                }
            }
        }
    },
    editorPage: {
        ...
        canvas: {
            removeAllRegions: {
                ...
                confirmation:
                    "¿Está seguro que quiere borrar todas las regiones?"
            }
        },
        messages: {
        ...
        providers: {
            common: {
                properties: {
                    ...
                    includeImages: {
                        ...
                        description:
                            "Si desea o no incluir activos de imagen binaria en la conexión de destino"
                    }
                }
            },
            vottJson: {
            ...
            azureCV: {
                ...
                properties: {
                    ...
                    region: {
                        title: "Región",
                        description:
                            "La región de Azure donde se implementa el servicio"
                    },
                    classificationType: {
            ...
            pascalVoc: {
                ...
                exportUnassigned: {
                    ...
                    description:
                        "Si se incluyen o no etiquetas no asignadas en los datos exportados"
                }
            },
            cntk: {
        ...
        form: {
            properties: {
                ...
                modelPath: {
                    ...
                    description:
                        "Seleccione un modelo de su sistema de archivos local"
                },
                modelUrl: {
                ...
                predictTag: {
                    ...
                    description:
                        "Si se incluirán o no automáticamente las etiquetas en las predicciones"
                }
            }
        },
        messages: {
            ...
            saveSuccess:
                "La configuración de aprendizaje activa se ha guardada correctamente"
        }
    },
    profile: {
    ...
    errors: {
        unknown: {
            ...
            message:
                "La aplicación contó un error desconocido.  Por favor inténtalo de nuevo."
        },
        projectUploadError: {
