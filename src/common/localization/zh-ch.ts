...
export const chinese: IAppStrings = {
    ...
    homePage: {
        ...
        importProject: {
            ...
            confirmation:
                "您确定要将项目${project.file.name}设置转换为v2格式吗？我们建议您首先备份项目文件。"
    ...
    connections: {
        ...
        imageCorsWarning:
            "警告：在Web浏览器中使用VoTT时，由于CORS（跨源资源共享）限制，来自Bing Image Search的某些素材可能无法正确导出。",
        ...
        blobCorsWarning:
            "警告：必须在Azure Blob存储帐户上启用CORS（跨域资源共享），才能将其用作源或目标连接。 {0}中提供了有关启用CORS的更多信息。",
    ...
    editorPage: {
        ...
        messages: {
            enforceTaggedRegions: {
                ...
                description:
                    "1个或多个区域尚未被标记。在继续下一个素材之前，请确保所有区域均已标记。"
    ...
    errors: {
        ...
        projectInvalidSecurityToken: {
            ...
            message:
                "项目引用的安全令牌无效。请验证是否在您的应用程序设置中正确设置了项目的安全令牌"
        ...
        projectDeleteError: {
            ...
            message:
                "删除项目时发生错误。验证项目文件和安全令牌是否存在，然后重试"
        ...
        securityTokenNotFound: {
            title: "加载项目文件时出错", // Error loading project file
            message:
                "在当前的应用程序设置中找不到该项目引用的安全令牌。验证安全令牌是否存在，然后尝试重新加载项目。"
        ...
        activeLearningPredictionError: {
            ...
            message:
                "预测当前素材中的区域时发生错误。请验证您的主动学习配置，然后重试"
