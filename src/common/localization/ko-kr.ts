...
export const korean: IAppStrings = {
    ...
    homePage: {
        ...
        importProject: {
            ...
            confirmation:
                "${project.file.name} 프로젝트 설정을 v2 형식으로 수정 하시겠습니까? 수정하시기 전에 프로젝트 파일을 백업해두시기 바랍니다."
    ...
    appSettings: {
        ...
        securityTokens: {
            ...
            description:
                "보안 토큰은 프로젝트 구성 내에서 중요한 데이터를 암호화하는 데 사용됩니다"
    ...
    projectSettings: {
        ...
        securityToken: {
            ...
            description:
                "프로젝트 파일 내에서 중요한 데이터를 암호화하는 데 사용" // Used to encrypt sensitive data within project file
        },
        ...
        messages: {
            saveSuccess:
                "${project.name} 프로젝트 설정을 성공적으로 저장했습니다" // Successfully saved ${project.name} project settings
        }
    },
    projectMetrics: {
    ...
    tags: {
        ...
        warnings: {
            existingName:
                "태그 이름이 이미 존재합니다. 다른 이름을 입력하십시오", // Tag name already exists. Choose another name,
    ...
    connections: {
        ...
        imageCorsWarning:
            "경고 : 웹 브라우저에서 VoTT를 사용하는 경우 CORS (Cross Origin Resource Sharing) " +
        ...
        blobCorsWarning:
            "경고 : 소스 또는 대상 연결로 사용하려면, Azure Blob Storage 계정에서 CORS(Cross Domain Resource Sharing) " +
        ...
        providers: {
            azureBlob: {
                ...
                sas: {
                    title: "SAS", // SAS,
                    description:
                        "Blob Storage 계정을 인증하는 데 사용되는 공유 액세스 서명"
            ...
            firebase: {
                ...
                createFolder: {
                    ...
                    description: "Crear Firebase directorio si no excite"
                }
            },
            minio: {
                title: "Minio Storage",
                ...
                createFolder: {
                    title: "Create Folder",
                    description:
                        "Creates the Minio Storage folder if it does not already exist"
                }
            }
        }
    },
    editorPage: {
        ...
        messages: {
            enforceTaggedRegions: {
                ...
                description:
                    "1 개 이상의 지역이 태그되어야 합니다. 다음 작업을 계속 진행하기 위해 모든 지역에 태그가 지정되어 있는지 확인하십시오."
    ...
    activeLearning: {
        ...
        messages: {
            ...
            errorLoadModel:
                "Active Learning 모델을 불러오는 중 오류가 발생했습니다", // Error loading active learning model,
    ...
    errors: {
        unknown: {
            ...
            message:
                "애플리케이션에 알 수 없는 오류가 발생했습니다. 다시 시도하십시오." // The app encountered an unknown error. Please try again"
        },
        projectUploadError: {
            title: "파일 업로드 오류", // Error Uploading File,
            message:
                "파일을 업로드하는 중에 오류가 발생했습니다. 파일이 올바른 형식인지 확인한 후 다시 시도하십시오."
        ...
        genericRenderError: {
            ...
            message:
                "응용 프로그램을 렌더링하는 중에 오류가 발생했습니다. 다시 시도하십시오"
        ...
        projectInvalidSecurityToken: {
            ...
            message:
                "프로젝트에서 참조한 보안 토큰이 유효하지 않습니다.응용 프로그램 설정 내에서 프로젝트의 보안 토큰이 올바르게 설정되었는지 확인하십시오"
        ...
        projectInvalidJson: {
            ...
            message:
                "선택한 프로젝트 파일에 유효한 JSON이 포함되어 있지 않습니다. 파일을 다시 확인하십시오."
        ...
        projectDeleteError: {
            ...
            message:
                "프로젝트를 삭제하는 중에 오류가 발생했습니다. 프로젝트 파일에 보안 토큰이 존재하는지 확인한 후 다시 시도하십시오."
        ...
        securityTokenNotFound: {
            title: "프로젝트 파일을 로드하는 중 오류가 발생했습니다", // Error loading project file,
            message:
                "프로젝트가 참조하는 보안 토큰을 현재 애플리케이션 설정에서 찾을 수 없습니다. 보안 토큰이 있는지 확인하고 프로젝트를 다시로드하십시오."
        ...
        canvasError: {
            ...
            message:
                "캔버스를 로드하는 중에 오류가 발생했습니다. 프로젝트 Asset을 확인한 후 다시 시도하십시오."
        ...
        importError: {
            ...
            message:
                "V1 프로젝트를 가져 오는 중에 오류가 발생했습니다. 프로젝트 파일을 확인하고 다시 시도하십시오."
        ...
        activeLearningPredictionError: {
            ...
            message:
                "현재 Asset의 지역을 예측하는 동안 오류가 발생했습니다. Active Learning 구성을 확인하고 다시 시도하십시오"
