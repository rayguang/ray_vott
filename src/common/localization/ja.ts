...
export const japanese: IAppStrings = {
    ...
    homePage: {
        ...
        importProject: {
            ...
            confirmation:
                "プロジェクト ${project.file.name} プロジェクト設定を v2 形式に変換してもいいですか"
    ...
    appSettings: {
        ...
        securityTokens: {
            ...
            description:
                "セキュリティ トークンは、プロジェクト構成内の機密データを暗号化するために使用されます"
    ...
    projectSettings: {
        ...
        securityToken: {
            ...
            description:
                "プロジェクト ファイル内の機密データを暗号化するために使用されます" // Used to encrypt sensitive data within project file"
        },
        ...
        videoSettings: {
            ...
            frameExtractionRate:
                "フレーム抽出率（ビデオ 1 秒あたりのフレーム数）" // Frame Extraction Rate (frames per a video second)"
        },
    ...
    connections: {
        ...
        imageCorsWarning:
            "警告：Web ブラウザーで VoTT を使用する場合、CORS（クロス オリジン リソース共有）の制限により、" +
        ...
        blobCorsWarning:
            "警告：ソースまたはターゲット接続として使用するには、Azure Blob Storage アカウントで CORS（クロス オリジン リソース共有）を有効にする必要があります。 ",
    ...
    editorPage: {
        ...
        tags: {
            ...
            delete: {
                ...
                confirmation:
                    "このタグを削除してもいいですか。このタグはすべてのアセットで削除され、このタグのみのあらゆる領域も削除されます"
        ...
        messages: {
            enforceTaggedRegions: {
                ...
                description:
                    "1 つ以上の領域にタグが付けられていません。次のアセットに進む前に、すべての領域をタグ付けしてください。"
            ...
            azureCV: {
                ...
                properties: {
                    ...
                    region: {
                        title: "領域", // Region,
                        description:
                            "サービスがデプロイされている Azure リージョン" // The Azure region where your service is deployed"
                    },
                    classificationType: {
    ...
    errors: {
        ...
        projectInvalidJson: {
            ...
            message:
                "選択したプロジェクト ファイルに有効なJSONが含まれていません。"
        ...
        securityTokenNotFound: {
            title: "プロジェクト ファイルの読み込みエラー", // Error loading project file,
            message:
                "プロジェクトが参照するセキュリティ トークンが現在のアプリケーション設定に見つかりません。"
        ...
        canvasError: {
            ...
            message:
                "キャンバスのロード中にエラーが発生しました。プロジェクトのアセットを確認して、再試行してください。"
        ...
        pasteRegionTooBigError: {
            ...
            message:
                "このアセットに対して領域が大きすぎます。別のリージョンをコピーしてください"
