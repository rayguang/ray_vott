...
import firebaseApp, {
    uiConfig
} from "../../../../react/components/common/firebaseHandler/firebaseHandler";
...
> {
    ...
    private cloudFilePicker: React.RefObject<
        CloudFilePicker
    > = React.createRef();
            ...
            <div className="app-homepage">
                        ...
                        {isElectron() && (
                            <li>
                                ...
                                >
                                    ...
                                    <h6>
                                        {
                                            strings.homePage.openLocalProject
                                                .title
                                        }
                                    </h6>
                                </a>
                    ...
                    this.props.recentProjects.length > 0 && (
                        <div className="app-homepage-recent bg-lighter-1">
                            <CondensedList
                                ...
                                onDelete={project =>
                                    this.deleteConfirm.current.open(project)
                                }
                            />
                        </div>
                    )}
                <Confirm
                    ...
                    message={(project: IProject) =>
                        `${strings.homePage.deleteProject.confirmation} ${
                            project.name
                        }?`
                    }
    ...
    private onProjectFileUploadError = (e, error: any) => {
        ...
        throw new AppError(
            ErrorCode.ProjectUploadError,
            "Error uploading project file"
        );
    };
    ...
    private convertProject = async (projectInfo: IFileInfo) => {
        ...
        try {
            ...
            throw new AppError(
                ErrorCode.V1ImportError,
                "Error converting v1 project file"
            );
        }
        ...
        try {
            generatedAssetMetadata = await importService.generateAssets(
                projectInfo,
                project
            );
            ...
            await generatedAssetMetadata.mapAsync(assetMetadata => {
                return this.props.actions.saveAssetMetadata(
                    this.props.project,
                    assetMetadata
                );
            });
            ...
            throw new Error(
                `Error importing project information - ${e.message}`
            );
        }
