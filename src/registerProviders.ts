...
export default function registerProviders() {
    ...
    StorageProviderFactory.register({
        ...
        displayName: strings.connections.providers.firebase.title,
        factory: options => new FirebaseStorage(options)
    });
    StorageProviderFactory.register({
        name: "minioStorage",
